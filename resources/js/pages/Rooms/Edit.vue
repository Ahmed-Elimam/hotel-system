...
const form = useForm({
  room_number: props.row.room_number,
  capacity: props.row.capacity,
  price: props.row.price,
  floor_id: props.row.floor_id,
  is_reserved: props.row.is_reserved,
});
const onSubmit = () => {
  form.put(route('rooms.update', props.row.id), {
    preserveScroll: true,
    onSuccess: () => {
        ...
        <CardContent class="p-6">
          ...
          <Form @submit="onSubmit">
              ...
              <div class="space-y-4">
                <FormField name="room_number">
                  <FormItem>
                    ...
                    <FormControl>
                      <Input v-model="form.room_number" type="text" placeholder="Room Number consisted of 4 digits"
                        readonly />
                    </FormControl>
                    <FormMessage />
            ...
            <div class="flex justify-center space-x-4 mt-8">
              <Button type="submit" class="bg-blue-600 hover:bg-blue-700">Update Room</Button>
